...
<body>
	...
	<section id="secondary_bar">
		...
		<div class="breadcrumbs_container">
			<article class="breadcrumbs"><a href="admin.php？controller=admin">后台管理系统</a> <div class="breadcrumb_divider"></div> <a class="current">修改新闻</a></article>
		</div>
...
<section id="main" class="column">
	...
	<form id="form1" name="form1" method="post" action="/updatenews">
	<article class="module width_full">
		<header><h3>修改新闻</h3></header>
			   <div class="module_content">
			   <fieldset>
						<label>类别</label>
                            头条<input name="newclass" type="radio" value="1"  style="width: 20px;height: 20px;vertical-align:middle;color:blue;">
                            动态<input name="newclass" type="radio" value="0" style="width: 20px;height: 20px;vertical-align:middle;">
                               
				</fieldset>
				<script>
                    $("input[name='newclass'][value='<?php echo ($data["newclass"]); ?>']").attr("checked","checked");
		...
		<footer>
			<div class="submit_link">
				<input type="hidden" name="id" value="<?php echo ($data["newid"]); ?>">
				<!-- <input type="hidden" name="class" value="<?php echo ($data["newclass"]); ?>"> -->
