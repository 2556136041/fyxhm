...
<p id="currpos">&nbsp;
<img id="currimg" src="/Public/images/comm/currentpos.png" align="top">&nbsp;当前位置：<a href="/index.html">首页</a> >> 热点
</p>

<table id="tab1" align="center" border="0" cellpadding="10" cellspacing="0"> 
<?php if(is_array($list)): foreach($list as $key=>$all): ?><tr>
<td height='25' width="100px" align='left' class='m_td'><div class="div_img"><img src="/Public/images/new/<?php echo ($all["pic"]); ?>" width="100px" height="65px" alt="" /></div></td>
<td height='25' width="" align='left' class='m_td'><a href="/topnewinfo/id/<?php echo ($all["newid"]); ?>.html"><h3><?php echo ($all["title"]); ?></h3></a></td>
