...
window.onload = function(){
    ...
    oBtn.onclick = function() {
	    ...
	    xhr.onload = function(){
	        ...
	        imagepath='/Public/images/pro/'+imagename;
	    ...
	    xhr.open('post','/upload_proimg',true); //open打开的方式不能使用get,上传文件的地址,使用异步上传
...
<body>
	...
	<section id="secondary_bar">
		...
		<div class="breadcrumbs_container">
			<article class="breadcrumbs"><a href="/admin">后台管理系统</a> <div class="breadcrumb_divider"></div> <a class="current">添加产品</a></article>
		</div>
...
<section id="main" class="column">
	...
	<form id="form1" name="form1" method="post" action="/prosave">
	<article class="module width_full">
		<header><h3>发表新产品</h3></header>
			   <div class="module_content">
				<fieldset>
						<label>型号</label>
							<input style="height:40px;font-size:18px;" type="text" name="prono">
				</fieldset>
                <fieldset>
						<label>名称</label>
							<input style="height:40px;font-size:18px;" type="text" name="proname">
				</fieldset>
                <fieldset>
						<label>价格</label>
							<input style="height:40px;font-size:18px;" type="text" name="proprice">
				</fieldset>
                <fieldset>
						<label>描述</label>
						<textarea style="padding:8px 0px 0px 8px;margin-top:8px;font-size:18px;" rows="8" name="proabout" id="lead"></textarea>
				</fieldset>
				
                <fieldset>
						<label>位置</label>
                            封面<input name="choice" type="radio" value="1"  style="width: 20px;height: 20px;vertical-align:middle;color:blue;">
                            正常<input name="choice" type="radio" value="0" style="width: 20px;height: 20px;vertical-align:middle;" checked>
				</fieldset>
				
             </div>
		<footer>
			<div class="submit_link">
				<input id='pic' type="hidden" name="propic" value="">
