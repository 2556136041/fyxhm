...
<body>
	...
	<section id="secondary_bar">
		...
		<div class="breadcrumbs_container">
			<article class="breadcrumbs"><a href="admin.php？controller=admin">后台管理系统</a> <div class="breadcrumb_divider"></div> <a class="current">红木知识修改</a></article>
		</div>
...
<section id="main" class="column">
	...
	<form id="form1" name="form1" method="post" action="/updateser.html">
	<article class="module width_full">
		<header><h3>服务知识修改</h3></header>
			   <div class="module_content">
			    <fieldset>
						<label>类别</label>
                            挑选<input name="serclass" type="radio" value="1"  style="width: 20px;height: 20px;vertical-align:middle;color:blue;">
                            保养<input name="serclass" type="radio" value="0" style="width: 20px;height: 20px;vertical-align:middle;">
                               
				</fieldset>
				<script>
                    $("input[name='serclass'][value='<?php echo ($data["serclass"]); ?>']").attr("checked","checked");

			    </script>
			    <fieldset>
						<label>位置</label>
                            封面轮播<input name="pos" type="radio" value="1"  style="width: 20px;height: 20px;vertical-align:middle;color:blue;">
                            正常<input name="pos" type="radio" value="0" style="width: 20px;height: 20px;vertical-align:middle;">
                               
				</fieldset>
				<script>
                    $("input[name='pos'][value='<?php echo ($data["pos"]); ?>']").attr("checked","checked");
                ...
                <fieldset style="width:48%;float:left; margin-right: 3%;">
						<label>作者</label>
						<input type="text" name="author" style="width:92%;height:40px;font-size:18px;" value="<?php echo ($data["author"]); ?>">
				</fieldset>
				<fieldset style="width:48%; float:right;">
					    <label>出处</label>
							<input type="text" name="from" style="width:92%;height:40px;font-size:18px;" value="<?php echo ($data["comfrom"]); ?>">
				</fieldset><div class="clear"></div>
                <fieldset>
						<p style="padding:0px 8px;margin:0px;font-size:12px;font-weight: bold;">导语</p>
						<textarea style="padding:8px 0px 0px 8px;margin-top:8px;font-size:16px;" rows="8" name="lead" id="lead"><?php echo ($data["lead"]); ?></textarea>
				</fieldset>
				<fieldset>
		...
		<footer>
			<div class="submit_link">
				<input type="hidden" name="id" value="<?php echo ($data["serid"]); ?>">
				<!-- <input type="hidden" name="class" value="<?php echo ($data["serclass"]); ?>"> -->
