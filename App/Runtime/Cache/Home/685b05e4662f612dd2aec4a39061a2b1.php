...
<body>
	...
	<section id="secondary_bar">
		...
		<div class="breadcrumbs_container">
			<article class="breadcrumbs"><a href="/admin">后台管理中心</a> <div class="breadcrumb_divider"></div> <a class="current">管理红木知识</a></article>
		</div>
			...
			<div id="tab1" class="tab_content">
				<table class="tablesorter" cellspacing="0" style="margin:0"> 
					...
					<?php if(is_array($data)): foreach($data as $key=>$value): ?><tr>
			    				<td><?php echo ($value["serid"]); ?></td> 
			    				<td>
			    				    <ul class="hoverbox">
					    				<li>
					    				<a href="#"><img src="/Public/images/service/<?php echo ($value["pic"]); ?>" alt="description"><img src="/Public/images/service/<?php echo ($value["pic"]); ?>" alt="" class="preview"></a>
					    				</li>
	                                </ul>
			    				</td>
                                ...
                                <td>
                                <?php if($value["serclass"] == 0): ?>动态
                                <?php else: ?>
                                头条<?php endif; ?>
                                </td> 
			    				<td>
                                <?php if($value["pos"] == 1): ?>切换
                                <?php else: ?>
                                正常位置<?php endif; ?>
                                </td> 
			    				<td><?php echo ($value["pubtime"]); ?></td> 
			    				<td><input type="image" src="/Public/images/comm/icn_edit.png" title="Edit" onClick="window.location.href='/serupdate/id/<?php echo ($value["serid"]); ?>'">
                                <?php if($flag == true): ?><input type="image" src="/Public/images/comm/icn_trash.png" title="Trash" onClick="window.location.href='/serdel/id/<?php echo ($value["serid"]); ?>'">
                                <?php elseif($flag == 0): ?>
				    			<!--
                                    <input type="image" src="/Public/images/comm/icn_trash.png" title="Trash" disabled="disabled" onClick="window.location.href='/serdel/id/<?php echo ($value["serid"]); ?>'">
								-->
				    			<?php else: endif; ?>		
			    				</td>
