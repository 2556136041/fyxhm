...
<aside id="sidebar" class="column">
	...
	<section id="main" class="column">
		...
		<header><h3 class="tabs_involved">活动列表</h3>
		</header>
			...
			<div id="tab1" class="tab_content">
				<table class="tablesorter" border="0" cellspacing="0" style="margin:0"> 
					...
					<?php if(is_array($data)): foreach($data as $key=>$value): ?><tr>
			    				<td><?php echo ($flag); echo ($value["id"]); ?></td> 
			    			    <td><?php echo ($value["title"]); ?></td>                               
			    				<td><?php echo ($value["pubtime"]); ?></td> 
			    				<td><input type="image" src="/Public/images/comm/icn_edit.png" title="Edit" onClick="window.location.href='/playupdate/id/<?php echo ($value["id"]); ?>'">
			    				<?php if($flag == 1): ?><input type="image" src="/Public/images/comm/icn_trash.png" title="Trash" onClick="window.location.href='/playdel/id/<?php echo ($value["id"]); ?>'">
			    				<?php elseif($flag == 0): ?>
								<!--
			    				    <input type="image" src="/Public/images/comm/icn_trash.png" disabled="disabled" title="Trash" onClick="window.location.href='/playdel/id/<?php echo ($value["id"]); ?>'">
								-->
								<?php else: endif; ?>
