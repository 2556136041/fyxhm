...
<div id="div_main">
	...
	<?php if(is_array($samepro)): foreach($samepro as $key=>$prosame): ?><p class="p_list" style="position: absolute;"><a href="/proshow/id/<?php echo ($prosame["proid"]); ?>.html"><div class="div_img"><img class="proimg" style="width:100%;" src="/Public/images/pro/<?php echo ($prosame["propic"]); ?>" /></div></a></p>
	<p class="p_list"><?php echo ($prosame["proname"]); ?></p><?php endforeach; endif; ?>

	</div>

    <script>
        // window.onload=function(){
        //       var classname=document.getElementByClassName('proimg').getAttribute("class");
        //       alert(classname);
        // }
         $(function(){
         	  if(screen.availWidth<=980){
         	  	  $(".proimg").css({"width":"50%","position":"relative","left":"50%","transform":"translate(-50%)"});
