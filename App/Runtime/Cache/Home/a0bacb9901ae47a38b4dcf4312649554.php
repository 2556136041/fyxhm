...
window.onload = function(){
    ...
    oBtn.onclick = function() {
	    ...
	    xhr.onload = function(){
	        ...
	        imagepath='/Public/images/play/'+imagename;
	    ...
	    xhr.open('post','/upload_playimg',true); //open打开的方式不能使用get,上传文件的地址,使用异步上传
...
<body>
	...
	<section id="secondary_bar">
		...
		<div class="breadcrumbs_container">
			<article class="breadcrumbs"><a href="/admin">后台管理系统</a> <div class="breadcrumb_divider"></div> <a class="current">添加活动</a></article>
		</div>
...
<section id="main" class="column">
     ...
     <form id="form1" name="form1" method="post" action="/playsave">
	 <article class="module width_full">
		<header><h3>发表新活动</h3></header>
