...
<body>
	...
	<section id="secondary_bar">
		...
		<div class="breadcrumbs_container">
			<article class="breadcrumbs"><a href="/admin">后台管理中心</a> <div class="breadcrumb_divider"></div> <a class="current">报名名单</a></article>
		</div>
...
<aside id="sidebar" class="column">
	...
	<section id="main" class="column">
		...
		<header><h3 class="tabs_involved">活动用户列表</h3>
		</header>
		<div class="tab_container">
			<div id="tab1" class="tab_content">
				<table class="tablesorter" cellspacing="0" style="margin:0"> 
                    ...
                    <tfoot> 
						<tr>  
			    			<td align='center' colspan="4" class="pages"><?php echo ($page); ?>
			    			</td>
						</tr> 
					</tfoot>
				</table>
