...
<p id="currpos">&nbsp;
<img id="currimg" src="/Public/images/comm/currentpos.png" align="top">&nbsp;当前位置：<a href="/index.php">首页</a> >> <a href="/top_all.html">热点</a>>>正文
</p>
...
<table border="0" cellspacing="10" cellpadding="0">
	<tr>
		<td><h1 align="center"><?php echo ($top["title"]); ?></h1></td>
    </tr>
    <tr>
		<td align="center"><span><?php echo ($top["author"]); ?></span>&nbsp;<span><?php echo ($top["comfrom"]); ?></span>&nbsp;<span><?php echo ($top["pubtime"]); ?></span></td>
	</tr>
    <tr>
		<td>
            <div id="share">
    ...
    <tr>
		<td><p id="p_lead"><?php echo ($top["lead"]); ?></p></td>
	</tr>
	<tr>
		<td align="center"><div class="div_img"><img src="/Public/images/new/<?php echo ($top["pic"]); ?>" width="600px" alt="" /></div></td>
	</tr>
    <tr>
		<td id="content"><?php echo (html_entity_decode($top["content"])); ?></td>
	</tr>
</table>
...
<table border="0" cellspacing="10" cellpadding="0" id="tab3">
	<tr>
	   <td>
		...
		<p class='classic_cut'>
		 <?php if(is_array($new)): $i = 0; $__LIST__ = array_slice($new,0,1,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$newvo): $mod = ($i % 2 );++$i;?><p class="p_img"><img src="/Public/images/new/<?php echo ($newvo["pic"]); ?>" alt="" />
		</p>
		<p class='classic_cut'>
		<p class="side_tit"><a href="/newsinfo/id/<?php echo ($newvo["newid"]); ?>.html"><?php echo ($newvo["title"]); ?></a></p><?php endforeach; endif; else: echo "" ;endif; ?>
		<div class="bcon">
            <div class="list_lh">
               <ul>
               <?php if(is_array($new)): $i = 0; $__LIST__ = array_slice($new,1,5,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$newvo): $mod = ($i % 2 );++$i;?><li><p class='flow'><a href="/newsinfo/id/<?php echo ($newvo["newid"]); ?>.html"><?php echo ($newvo["title"]); ?></a></p></li><?php endforeach; endif; else: echo "" ;endif; ?>
               </ul>
            </div>
        </div>
		</td>
	...
	<tr>
		<td>
		<p class="side_bar">选购</p>
		<p class="sideline"><span class="sideline_w"></span><span class="sideline_l"></span></p>
		<p class='classic_cut'>
		<p class="p_img"><img src="/Public/images/service/<?php echo ($choose["pic"]); ?>" alt="" />
		</p>
		<p class='classic_cut'>
		<p class="side_tit"><a href="/chooseinfo/id/<?php echo ($choose["serid"]); ?>.html"><?php echo ($choose["title"]); ?></a></p>
		</td>
	</tr>
	<tr>
		<td>
