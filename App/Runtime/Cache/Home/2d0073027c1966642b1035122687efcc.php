...
window.onload = function(){
    ...
    oBtn.onclick = function() {
	    ...
	    xhr.open('post','/upload_ser',true); //open打开的方式不能使用get,上传文件的地址,使用异步上传
...
<body>
	...
	<section id="secondary_bar">
		...
		<div class="breadcrumbs_container">
			<article class="breadcrumbs"><a href="/admin.html">后台管理系统</a> <div class="breadcrumb_divider"></div> <a class="current">添加红木知识</a></article>
		</div>
...
<section id="main" class="column">
	...
	<form id="form1" name="form1" method="post" action="/sersave.html">
	<article class="module width_full">
		<header><h3>发表服务文章</h3></header>
			   <div class="module_content">
                <fieldset>
						<label>类别</label>
							<select name="serclass" id="" style="height:30px;width:100px;font-size:16px;font-family:'微软雅黑';border-radius:5px;;">
                               <option value="0">挑选</option>
