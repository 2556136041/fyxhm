...
<body>
	...
	<section id="secondary_bar">
		...
		<div class="breadcrumbs_container">
			<article class="breadcrumbs"><a href="/admin">后台管理中心</a> <div class="breadcrumb_divider"></div> <a class="current">管理新闻</a></article>
		</div>
				...
				<table class="tablesorter" cellspacing="0" style="margin:0"> 
					...
					<?php if(is_array($data)): foreach($data as $key=>$value): ?><tr>
			    				...
			    				<td>
			    				    <ul class="hoverbox">
					    				<li>
					    				<a href="#"><img src="/Public/images/new/<?php echo ($value["pic"]); ?>" alt="description"><img src="/Public/images/new/<?php echo ($value["pic"]); ?>" alt="" class="preview"></a>
					    				</li>
	                                </ul>
			    				</td>
			    				...
			    				<td><input type="image" src="/Public/images/comm/icn_edit.png" title="Edit" onClick="window.location.href='/newsupdate/id/<?php echo ($value["newid"]); ?>'">
			    				<?php if($flag == true): ?><input type="image" src="/Public/images/comm/icn_trash.png" title="Trash" onClick="window.location.href='/newsdel/id/<?php echo ($value["newid"]); ?>'">
			    				<?php elseif($flag == 0): ?>
				    			<!--
			    				    <input type="image" src="/Public/images/comm/icn_trash.png" disabled="disabled" title="Trash" onClick="window.location.href='/newsdel/id/<?php echo ($value["newid"]); ?>'">
                                -->
				    			<?php else: endif; ?>
