...
<body>
	...
	<section id="secondary_bar">
		...
		<div class="breadcrumbs_container">
			<article class="breadcrumbs"><a href="/admin">后台管理中心</a> <div class="breadcrumb_divider"></div> <a class="current">管理产品</a></article>
		</div>
	...
	<section id="main" class="column">
		...
		<div class="tab_container">
			<div id="tab1" class="tab_content">
				<table class="tablesorter" border="0px" cellspacing="0" style="margin:0"> 
					<thead> 
						<tr>  
			    				<th>ID</th>
			    				<th>图片</th>
					...
					<?php if(is_array($data)): foreach($data as $key=>$value): ?><tr>
			    				...
			    				<td>
			    				    <ul class="hoverbox">
					    				<li>
					    				<a href="#"><img src="/Public/images/pro/<?php echo ($value["propic"]); ?>" alt="description"><img src="/Public/images/pro/<?php echo ($value["propic"]); ?>" alt="" class="preview"></a>
					    				</li>
	                                </ul>
			    				</td>
			    				<td><?php echo ($value["prono"]); ?></td> 
			    				<td><?php echo ($value["proname"]); ?></td> 
                                <td><?php echo ($value["proprice"]); ?></td>
			    				<td>
                                <?php if($value["choice"] == 1): ?>封面
                                <?php else: ?>
                                正常位置<?php endif; ?>
                                </td> 
			    				<td><?php echo ($value["pubtime"]); ?></td> 
			    				<td><input type="image" src="/Public/images/comm/icn_edit.png" title="Edit" onClick="window.location.href='/proupdate/id/<?php echo ($value["proid"]); ?>'">
                                <?php if($flag == 1): ?><input type="image" src="/Public/images/comm/icn_trash.png" title="Trash" onClick="window.location.href='/prodel/id/<?php echo ($value["proid"]); ?>'">
				    			<?php elseif($flag == 0): ?>
				    			<!--
				    				<input type="image" src="/Public/images/comm/icn_trash.png" title="Trash" disabled="disabled" onClick="window.location.href='/prodel/id/<?php echo ($value["proid"]); ?>'">
				    			-->
				    			<?php else: endif; ?>
			    				</td>
