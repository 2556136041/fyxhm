...
.text-dark{
 ...
 <table class="bg-danger text-white" id="reg" border="0" cellspacing="20" cellpadding="20"> 
 <tr> 
...
<tr> 
    <td align="center">
   <button id="tjbut" class="btn btn-warning btn-block" onclick="login_ajax()">提交</button>
    </td> 
</tr> 
<tr> 
    <td align="center" style="color:white;font-size:40px;">
    <span id="sign1">已报名</span><span id="sign2"><b><?php echo ((isset($counts) && ($counts !== ""))?($counts):"0"); ?>人</b></span>&nbsp;<span id="sign1">浏览量</span><span id="sign2"><b><?php echo ((isset($playhits) && ($playhits !== ""))?($playhits):'1'); ?></b></span>
    </td> 
 </tr>
</table> 
...
<div id="bot">
     <p style="text-align:center;"><a href="tel:4008899446"><img src="/Public/images/comm/tel.png" style="padding-right:5px;width:70px;height:80%;vertical-align: middle;"><b>拨打电话</b></a></p><a href="javascript:void(0)" id="fast" style="color:white;"><img src="/Public/images/comm/dianji1.png" align="center" alt="" style="padding-right:5px;width:70px;height: 80%;vertical-align: middle;">点击报名</a>
</div>
