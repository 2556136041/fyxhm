...
<p id="currpos">&nbsp;
<img id="currimg" src="/Public/images/comm/currentpos.png" align="top">&nbsp;当前位置：<a href="/index.html">首页</a> >> <a href="/news_all.html">动态</a> >> 正文
</p>
<div id="div_main">
<div id="div_l">
<table border="0" cellspacing="10" cellpadding="0">
	<tr>
		<td><h1 align="center"><?php echo ($new["title"]); ?></h1></td>
    </tr>
    <tr>
		<td align="center"><span><?php echo ($new["author"]); ?></span>&nbsp;<span><?php echo ($new["comfrom"]); ?></span>&nbsp;<span><?php echo ($new["pubtime"]); ?></span></td>
	</tr>
    <tr>
		<td>
            <div id="share">
    ...
    <tr>
		<td><p id="p_lead"><?php echo ($new["lead"]); ?></p></td>
	</tr>
	<tr>
		<td align="center"><div class="div_img"><img src="/Public/images/new/<?php echo ($new["pic"]); ?>" width="600px" alt="" /></div></td>
	</tr>
    <tr>
		<td id="content"><?php echo (html_entity_decode($new["content"])); ?></td>
	</tr>
</table>
...
<a href="javascript:void(0);" id="btn" class='top' title="回到顶部"></a>
</body>
</html>