...
<p id="p_view" align="right" style="color:black;font-size:18px;background: rgb(250,196,2);">
...
<h2 style="margin-top: 10px;" class="display-2 text-danger">这个周末</h2>
<h2 class="display-2" style="color:rgb(153,0,51);">就是双11&nbsp;&nbsp;</h2>
<h2 class="display-2" style="color:rgb(153,0,51);">你准备好了吗？</h2>
